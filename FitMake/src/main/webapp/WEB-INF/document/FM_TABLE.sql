...
/* Create Foreign Keys */
ALTER TABLE FM_ITEM DROP FOREIGN KEY FM_CATEGORY_NO;
ALTER TABLE FM_CART DROP FOREIGN KEY FM_ITEM_NO;
ALTER TABLE FM_ITEM_IMG DROP FOREIGN KEY FM_ITEM_NO;
ALTER TABLE FM_ORDER_DETAIL DROP FOREIGN KEY FM_ITEM_NO;
ALTER TABLE FM_RECOMMAND DROP FOREIGN KEY FM_ITEM_NO;
ALTER TABLE FM_REVIEW DROP FOREIGN KEY FM_ITEM_NO;
ALTER TABLE FM_ORDER_DETAIL DROP FOREIGN KEY FM_ORDER_NO;
ALTER TABLE FM_REPLY DROP FOREIGN KEY FM_REVIEW_NO;
ALTER TABLE FM_REVIEW_IMG DROP FOREIGN KEY FM_REVIEW_NO;
ALTER TABLE FM_CART DROP FOREIGN KEY FM_USER_NO;
ALTER TABLE FM_ORDER DROP FOREIGN KEY FM_USER_NO;
ALTER TABLE FM_REPLY DROP FOREIGN KEY FM_USER_NO;
ALTER TABLE FM_USER_BMI DROP FOREIGN KEY FM_USER_NO;
ALTER TABLE FM_REVIEW DROP FOREIGN KEY FM_USER_NO;
ALTER TABLE FM_RECOMMAND DROP FOREIGN KEY FM_USER_BMI_NO;
ALTER TABLE FM_POINT DROP FOREIGN KEY FM_USER_NO;
ALTER TABLE FM_INQUIRY_REPLY DROP FOREIGN KEY FM_INQUIRY_NO;
ALTER TABLE FM_INQUIRY DROP FOREIGN KEY FM_USER_NO;
