			...
			<form action='./addCtr.do' method='post' id="addctrForm">
				...
				<div class="input_p_Css">
					...
					<input type='tel' name='mobile' id="mobileChk" class="input_Css"
						placeholder="휴대폰 번호 입력"> <span id="phoneChk" class="doubleChk">인증번호 보내기</span><br>
				...
				<div class="input_p_Css">
					...
					<input type="text" id="zipcode_Id" name="zipCode"
						placeholder="우편번호"> <input type="button"
						onclick="kakaoAddressFnc();" value="우편번호 찾기"><br> <input
						type="text" id="add_1st" name="add_1st" placeholder="주소"><br>
					<input type="text" id="add_Detail" name="add_Detail"
						placeholder="상세주소"> <input type="text" id="add_Extra"
						name="add_Extra" placeholder="참고항목">
				</div>
				<div class="input_p_Css">
					<p>
